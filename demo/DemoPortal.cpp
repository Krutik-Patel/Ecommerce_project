        ...
        if (reqIndex >= 0)
        {
            ...
            else if (request[0] == "List")
            {
                ...
                for (int ind1 = 0; ind1 < response.size(); ind1++)
                {
                    ...
                    product.setPrice(stof(response[ind1][4]));
                ...
                {
                    cout << products[product].getProductName() << " " << products[product].getProductUniqueName() << " " << fixed << setprecision(2) << products[product].getPrice() << " " << products[product].getQuantityAvailable();
                    cout << endl;
                }
            }
